    ...
    <div className="container mx-auto px-4 py-8 md:px-6 md:py-12 text-right">
      <div className="grid md:grid-cols-5 gap-8 lg:gap-12">
        ...
        <div className="md:col-span-3">
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center gap-2 mt-3 justify-end">
                <Link href={`/chefs/${chef.id}`} className="font-semibold text-lg hover:underline">{chef.name}</Link>
            ...
            <div>
              <h3 className="font-bold text-xl mb-3">المكونات</h3>
        ...
        <div className="md:col-span-2">
           <Card>
            <CardHeader>
                <CardTitle className="text-2xl font-headline">آراء العملاء</CardTitle>
                 {ratingsCount > 0 && (
                    <div className="flex items-center gap-2 pt-2 justify-end">
                        <span className="text-sm text-muted-foreground">({ratingsCount} تقييم)</span>
            ...
            <CardContent>
                {sortedRatings.length > 0 ? (
                    ...
                    <div className="text-center py-10">
                        <p className="text-muted-foreground">لا توجد تقييمات لهذا الطبق بعد. كن أول من يجرّبه!</p>
                    </div>
                )}
            </CardContent>
           </Card>
